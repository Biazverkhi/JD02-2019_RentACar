...
import by.fastrentcar.dao.BaseDao;
...
public class DefaultAuthUserDAO {
    private static final Logger log = LoggerFactory.getLogger(DefaultAuthUserDAO.class);



//    public DefaultAuthUserDAO(Class clazz, EntityManagerFactory factory) {
//        super(clazz, factory);
//    }
//
//    @Override
...
//            List<AuthUserEntity> list = (List<AuthUserEntity>) get.createQuery("from AuthUserEntity aue where aue.login=:login ")
